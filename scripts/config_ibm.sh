...
providers=( ibm ) # gcf azure ibm )
configs=( "0,0,1" "0,0,0.5" "60,60,1"  "60,60,0.5"  "60,60,0" ) #"0,0,2" "60,60,2"
target_urls=( https://service.eu.apiconnect.ibmcloud.com/gws/apigateway/api/51ba75c787dfa78656ccf74881c03cd2762d1060f6c4cd36bd0ce83fdeeab5c0/benchmark ) #http://sls-uks-dev-tub-elasticity-benchmark.azurewebsites.net/api/hello ) 
